...
while rand_list:
    ...
    for x in rand_list:
        ...
        if x < minimum:
            # if the iteration number lower than the first number of the rand_list, the ireration number become a new minimun number
            minimum = x
...
for i in sorted_list:
    # checking the each number whether the number is  an odd number
    if i %2 != 0:
...
# print the average value of the list with the odd numbers, the sum of all the numbers in the list divide by lenth of the numbers of the list
print(f'The aberage value of odd numbers is {sum(list_of_odd_numbers)*len(list_of_odd_numbers)}')
# print the average value of the list with the even numbers, the sum of all the numbers in the list divide by lenth of the numbers of the list
